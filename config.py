...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1707380693").split()))
DEEP_AI = getenv("DEEP_AI", "d7394561-0528-4714-a1ee-edd7020b48e1")
OWNER_ID = int(getenv("OWNER_ID", "6124944836") or 0)
ADMIN1_ID = list(map(int, getenv("ADMIN1_ID", "6124944836").split()))
